...
The system collects data from a meteorological station equipped with a Pyranometer radiation sensor, anemometer, temperature gauge, and hygrometer. 
...
* the wind sensor reading pin is A0 and not A4.
...
* The ADS1115 is a 16-bit ADC, meaning it provides 65,536 discrete levels (from -32,768 to +32,767 in differential mode).
  ...
  We measured an output of 0.97V between strong illuminance and darkness.
